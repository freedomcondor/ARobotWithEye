...
require("blocktracking/func")   -- root function for blocktracking
...
function step()
   robot.camera.tags.n = #robot.camera.tags
   blocktracking(robot.camera.tags)
   --print_tag_info()
end
